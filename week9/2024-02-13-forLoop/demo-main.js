...
// In diesem Beispiel haben wir eien äusere schleife, die vio 1 bis 3 läuft, und eine inner schleife die von 1 bis 5 läuft.
// Bei dene Durchlauf der äussen schleife wied die inne schleife vollständig durchlaufen (5)
...
// array mit zahlen
let zahlen = [3, 32, 2, 4, 2, 54, 56, 34, 45, 3, 4, 23, 5, 67, 66, 45, 3, 4, 5, 34, 3, 100, 8];
...
console.log(`die Durchschnittsnote des Schülers ist: ${durchschnittsNotenVariabele}`);
...
// * ohne Array / String
// Wenn ich eine schleife benötige die nicht abhängig ist von einen index wie vom string / Array 
// benutzen wir eine ->for<- schleife. hier kann ich individuell den start und den end punkt asuwählen wieoft die schleife durchlaufen soll.
